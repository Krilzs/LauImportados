...
const Filters = ({
  ...
  return (
    ...
    >
      <h5
        className="h-12 flex items-center w-full justify-center font-semibold text-gray-800 cursor-pointer hover:bg-gray-500 hover:text-white transition-all duration-300 ease-in-out "
